...
def user_tweets(twitter_handle):
  ...
  print('In order to view the full user_tweets() df, I think it is easiest to view it as an excel file, so there is a to_csv() function included. If you would like to view csv file in excel please edit the filepath in the line below.')
  print('If the .to_csv() line remains commented out and no filepath is provided, the function will just return the new df' )
  #user_tweets_df.to_csv('ENTER USER SPECIFIC FILEPATH HERE', index=False)
...
user_tweets('@stoolpresidente')

#----------------------------------------------------------------------

#Application of sentiment analysis to political tweets about the United States
