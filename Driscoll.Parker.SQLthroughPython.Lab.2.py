...
cur.execute("""
INSERT or REPLACE INTO users(userid, fname, lname, gender)
...
cur.executemany("INSERT or REPLACE INTO users(userid, fname, lname, gender)VALUES(?,?,?,?);", customers)
conn.commit()

cur.executemany("INSERT or REPLACE INTO orders(orderid, date, userid, total)VALUES(?,?,?,?);", orders)
conn.commit()
